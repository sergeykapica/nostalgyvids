...
<p class="pagination">
		...
		<a title="Первая" href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?php echo __('<<') ?></a>

		<a title="Предыдущая" href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('<') ?></a>
	...
	<?php endforeach ?>
		...
		<a title="Следующая" href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('>') ?></a>

		<a title="Последняя" href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('>>') ?></a>
